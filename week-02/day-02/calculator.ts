...
let inputChars: any[] = ['-', 3, 5];

function calculate(inputChars) {
    if (inputChars[0] === '+' && inputChars.length === 3) {
        return `${inputChars[1]} ${inputChars[0]} ${inputChars[2]} = ${inputChars[1]+inputChars[2]} \nGoodbye!`;

    } else if (inputChars[0] === '-' && inputChars.length === 3) {
        return `${inputChars[1]} ${inputChars[0]} ${inputChars[2]} = ${inputChars[1]-inputChars[2]} \nGoodbye!`;
...
console.log(calculate(inputChars));
